...
def main():
    ...
    icon = pygame.image.load('lab9/icon.jpg')
    ...
    brush_png = pygame.transform.scale(pygame.image.load("lab9/brush.jpg"), (20,20))
    eraser_png = pygame.transform.scale(pygame.image.load("lab9/eraser.jpg"), (20,20))
    clear_png = pygame.transform.scale(pygame.image.load("lab9/Clear.png"), (30, 30))
    save_png = pygame.transform.scale(pygame.image.load("lab9/save.png"), (98, 50))
    ...
    def size_buttons():
        ...
        sz_btn = pygame.transform.scale(pygame.image.load("lab9/size.png"), (25, 25))
